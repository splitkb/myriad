...
If you want to comfirm whether you are understanding the specification correctly, why not try decoding one of the [example records](examples.html)?
...
| 1 | uint8 | [Pin number](/specification/pinout.html) on the connector, contact A.
| 1 | uint8 | [Pin number](/specification/pinout.html) on the connector, contact B.
| 1 | uint8 | Configuration bit field
...
| 1 | `0x03` | Data length in bytes.
| 1 | uint8 | [Pin number](/specification/pinout.html) on the connector, X axis.
| 1 | uint8 | [Pin number](/specification/pinout.html) on the connector, Y axis.
| 1 | uint8 | Configuration bit field
